...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-500 via-pink-500 to-indigo-500 dark:from-slate-900 dark:via-purple-900 dark:to-slate-900 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="card bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg rounded-3xl shadow-2xl p-8 animate-fadeIn">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-lg">Join us today and get organized!</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className={`input-enhanced w-full px-4 py-4 border-2 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 ${
                  formErrors.name 
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 flex items-center gap-2">
                <span className="text-lg">🔒</span>
                Confirm Password
              </label>
              <input
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600 dark:text-gray-300 text-lg">
              ...
              <Link 
                to="/login" 
                className="text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-bold transition-colors duration-300"
              >
                Sign in here 🎯
              </Link>
            </p>
